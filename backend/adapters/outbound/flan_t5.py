# This is where it all started. FLAN-T5-Large was the original model powering Understand-IT
# before the architecture was rebuilt around swappable adapters. Kept as a tribute.
